...
std::vector<cmesh_ref> read_ogre_mesh_file ( const char* szFileName, const char* VSh, const char* FSh, cbinary_helper* curr_helper ) {
    ...
    if ( curr_helper )
		...
		bin_help = new cbinary_helper ( szFileName );
...
std::vector <cskel_bone> read_ogre_bones ( const char* filename, cbinary_helper* curr_helper ) {
    cbinary_helper* bin_help;
